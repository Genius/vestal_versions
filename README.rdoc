= Vestal Versions (Genius fork)

{<img src="https://badge.fury.io/rb/vestal_versions.png" alt="Gem Version" />}[http://badge.fury.io/rb/vestal_versions]
{<img src="https://github.com/Genius/vestal_versions/actions/workflows/ci.yml/badge.svg" alt="Build Status" />}[https://github.com/Genius/vestal_versions/actions/workflows/ci.yml]
...
Requires Active Record 4.2. Rails 4.2 is end-of-life upstream, so the test suite runs against the
Rails LTS builds hosted at gems.railslts.com.
